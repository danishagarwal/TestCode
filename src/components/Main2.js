...
const Main2 = () => {
  ...
  const handleSave = () => {
    ...
    // Storing data to in memory
    const newData = { name, sectors, agree };
    setFormData(newData);
  ...
  const handleEdit = () => {
    // Allowing the user to edit stored data
    if (formData) {
  ...
  return (
    <div className="bg-red-100 pt-10 pb-60">
      <div className="bg-opacity-70 bg-black max-w-lg mx-auto my-24 px-5 py-10 rounded-lg text-white shadow-xl">
        ...
        <div className="mt-5">
          ...
          <input
            ...
            type="text"
            className="block w-full p-2 border rounded bg-gray-500 border-gray-500"
          ></input>
        </div>
        <br></br>
        <label className="font-semibold">Sectors</label>
        <select
          className="text-sm  bg-gray-500 w-full p-4 rounded-lg my-2 border border-gray-500"
          multiple
          size="5"
          value={sectors}
          onChange={(e) =>
        ...
        <div className="mt-5 flex justify-between">
          <button
            onClick={handleSave}
            className="py-3 bg-red-700 rounded-lg text-white w-2/5"
          >
            Submit
          </button>
          <br></br>
